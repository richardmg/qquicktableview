    ...
    : QQmlPropertyCache()
{
    ...
    if (metaObjectRevision > 0) {
        // Explicitly set the revision of the meta object that this cache describes to be
        // 'metaObjectRevision'. This is mostly useful for constructing a property cache
