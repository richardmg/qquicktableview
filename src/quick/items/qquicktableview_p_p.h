...
public:
    ...
    public:
        ...
        inline QPoint firstCell() { return cellAt(0); }
        inline QPoint lastCell() { return cellAt(m_visibleCellsInEdge.count() - 1); }
        inline QPoint currentCell() { return cellAt(m_currentIndex); }
        inline QPoint previousCell() { return cellAt(m_currentIndex - 1); }

        inline bool atBeginning() { return m_currentIndex == 0; }
        ...
        QString toString()
        {
            ...
            dbg.nospace() << "TableSectionLoadRequest(" << "edge:"
                << m_edge << ", from:" << firstCell() << ", to:" << lastCell() << ", incubation:";
    ...
    private:
        ...
        inline QPoint cellAt(int index) {
            return m_edge & (Qt::LeftEdge | Qt::RightEdge)
