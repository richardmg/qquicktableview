...
void QQuickTableView::setModel(const QVariant &newModel)
{
    ...
    if (d->model) {
//        disconnect(d->model, SIGNAL(modelUpdated(QQmlChangeSet,bool)), this, SLOT(modelUpdated(QQmlChangeSet,bool)));
...
//        connect(d->model, SIGNAL(modelUpdated(QQmlChangeSet,bool)), this, SLOT(modelUpdated(QQmlChangeSet,bool)));
//        emit countChanged();
    }
