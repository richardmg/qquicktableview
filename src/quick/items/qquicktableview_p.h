...
class Q_AUTOTEST_EXPORT QQuickTableView : public QQuickItem
{
    ...
    Q_PROPERTY(QQuickFlickable *flickable READ flickable)
    Q_PROPERTY(QQuickItem* contentItem READ contentItem WRITE setContentItem NOTIFY contentItemChanged)
    Q_PROPERTY(qreal contentX READ contentX WRITE setContentX NOTIFY contentXChanged)
    Q_PROPERTY(qreal contentY READ contentY WRITE setContentY NOTIFY contentYChanged)
    Q_PROPERTY(qreal accumulatedTableWidth READ accumulatedTableWidth NOTIFY accumulatedTableWidthChanged)
    Q_PROPERTY(qreal accumulatedTableHeight READ accumulatedTableHeight NOTIFY accumulatedTableHeightChanged)
...
public:
    ...
    qreal accumulatedTableWidth() const;
    qreal accumulatedTableHeight() const;
...
Q_SIGNALS:
    ...
    void accumulatedTableWidthChanged();
    void accumulatedTableHeightChanged();
...
class QQuickTableViewAttached : public QObject
{
    Q_OBJECT
...
public:
    ...
    void setView(QQuickTableView *view) {
        if (view != m_view) {
            m_view = view;
            Q_EMIT viewChanged();
        }
