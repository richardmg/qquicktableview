...
class Q_QUICK_PRIVATE_EXPORT QQuickAbstractItemView : public QQuickFlickable
{
    ...
    Q_PROPERTY(QQmlListProperty<QQmlDelegate> delegates READ delegates NOTIFY delegatesChanged REVISION 10)
...
Q_SIGNALS:
    ...
    Q_REVISION(10) void delegatesChanged();
    void countChanged();
...
protected Q_SLOTS:
    void destroyRemoved();
    virtual void createdItem(int index, QObject *item);
