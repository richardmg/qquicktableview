...
void tst_QQuickTableView::checkSyncView_differentSizedModels()
{
    ...
    auto tableViewHModel = TestModelAsVariant(100, 20);
    auto tableViewVModel = TestModelAsVariant(20, 100);
    ...
    QCOMPARE(tableViewHVPrivate->loadedTableOuterRect.left(), leftEdge);
    QCOMPARE(tableViewHPrivate->leftColumn(), leftColumn);
    QCOMPARE(tableViewHVPrivate->leftColumn(), leftColumn);
}
